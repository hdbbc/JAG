...
T0=load('Raw_T(Task1)_(L1-100)_(D82-2)_F(7-3)_A9_C1.dat');
...
SampEnVal=SampEn(x0, 2, 0.15*biaozhuncha);
...
SampEnValue(aaa)=roundn(SampEnVal,-4);
...
%  ydata=[zuidazhiresult',junfanggenresult',PCC',biaozhuncharesult',SampEnValr',JSSr',HWSr'];
  ydata=[zuidazhiresult',junfanggenresult',PCC',biaozhuncharesult',SampEnValue'];
