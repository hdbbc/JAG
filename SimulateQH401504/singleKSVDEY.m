%% 载入信号
  ...
  tic
    ...
    RawMT=load('QH401504TS5EYSVMNoisy.dat');
    RawMTGood=load('QH401504TS5EYSVMGood.dat');
...
%%  数据输出
   ...
   %% 数据替换
      MTKSVD=Mtdata+average+RawMTGood;
      Original(300001:750000)=MTKSVD;
      MTKSVD=Original;
      fids1=fopen('QH401504TS5EYSVMKSVD.dat', 'wt');%去噪后的高频信号
      fprintf(fids1,'%10.0f%10.0f',MTKSVD);
      fclose(fids1);
      Check=load('QH401504TS5EYSVMKSVD.dat');
%%
      Nosiefree=load('QH401504TS5EY.dat');
   figure
